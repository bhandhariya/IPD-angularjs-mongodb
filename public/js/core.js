angular.module('myApp',['register','addservice','billing','summury','prefix','dashborad','patient','pharmacy','ngRoute','ngMaterial','toastr']).config(
  function($routeProvider){
    ...
    when("/pharmacy",{
      templateUrl : "/js/view/pharmacy.html",
    ...
    when("/supplierwiseledger",{
      templateUrl : "/js/view/supplierwiseledger.html",
      controller:'supplierwiseledgerctrl'
    }).
    when("/purchase/:sid",{
      templateUrl : "/js/view/purchase.html",
